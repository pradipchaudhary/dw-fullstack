...
//                 .status(400)
//                 .send(
//                     `Image dimensions should not exceed ${maxWidth}x${maxHeight} pixels. Your image is ${metadata.width}x${metadata.height} pixels.`
//                 );
//         }

//         next(); // Proceed to the next middleware if dimensions are valid
//     } catch (err) {
